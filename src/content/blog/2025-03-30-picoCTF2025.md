...
description: 'picoCTF 2025 writeup PWN'
date: '2025-03-30'
draft: false
tags: [writeup]
...
RSP bị overflow ở byte thứ 20, `fgets(feedback, 32, stdin)`, tức là ta chỉ có thể ghi 32-20=12 bytes, loại bỏ ý tưởng nop sled tới shellcode vì 12 bytes không thể chứa shellcode, ta chỉ có thể đặt 1 địa chỉ 8 bytes và mình chọn gadget `jmp rax` vì rax có trỏ tới giá trị mình nhập
